...
const UserCard = () => {
  return (
    <main className="w-10/12  md:w-11/12 mx-auto  rounded-lg bg-white shadow-xl mt-5">
      ...
      <section className="w-10/12 mx-auto relative lg:bottom-12 gap-10 flex px-10 py-8 md:gap-24 items-center justify-center rounded-lg bg-blue-100 lg:w-2/3  lg:px-2 lg:mt-0 bottom-7">
        <div>
          ...
          <p className="text-blue-900 font-mono text-lg md:text-xl font-bold leading-normal uppercase">
            57
          </p>
        </div>
        <div>
